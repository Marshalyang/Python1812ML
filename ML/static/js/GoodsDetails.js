$(function () {
	...
	$("#product_choose_size_ul li").click(
		function () {

			$(this).addClass("aaa")
			$("#product_choose_size_ul li").removeClass("aaa")
			$(this).addClass("aaa")
		}
	)

	$(".join_shopping_bag").click(
		function () {
			...
			if($('.aaa')){
				...
				$.get('../../shoppingbag/',{
				'goodsid':$('.join_shopping_bag').attr('goodsid'),
